...
namespace WorldCupDL.Models
{
    public class TeamResultsAPI
    {
        ...
        public static IList<TeamResultsAPI> FromJson(string json) => JsonConvert.DeserializeObject<IList<TeamResultsAPI>>(json, WorldCupDL.Handlers.TeamConverter.Settings);
